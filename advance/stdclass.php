    ...
    <div class="container">
        <div class="item">
            ...
            <ol id="here-home"></ol>
				...
				<fieldset id="Std Class">
					<legend>Std Class</legend>
                    <p>Std class adalah prototype class php yang berfungsi sebagai class penampungan jika sebuah tipe data
                    di php dirubah menjadi tipe data object.</p>
                    <hr>
                    <div>
                        <?php
                            $assarr = [
                            ...
                            var_dump ($assarr); // Array
                            
                            
                            $newobj = (object) $assarr; // type casting
                            var_dump ($newobj); //  berubah menjadi object
                        ...
                        ?>
                        <br>
                        <embed src="../script/std-class.pdf" width=600px height="250">
                    </div>
                </fieldset>
