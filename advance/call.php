    ...
    <div class="container">
        <div class="item">
            ...
            <ol id="here-home"> 
				...
				<fieldset id="call">
					<legend>Magic method call</legend>
                    <p>Magic method call akan dijalankan pada kondisi <em class="strong">sebuah method yang dipanggil tidak ada atau tidak
                    dapat diakses</em>.</p>
                    ...
                    <div>
                        <?php
                            class Kelas {
                                ...
                                public function __call ($name,$argumen) {
                            ...
                            echo $object->akses();
                            // echo $object->noakses();
                            // Uncaught Error: Call to private method Kelas::noakses()
                            echo $object->noakses(1,2,4);
                        ?>
                        <legend>True</legend>
                        <embed src="../script/magic-method-call.pdf" width=600px height="250">
                    </div>
