        ...
        <div class="item">
            ...
            <ol id="here-home"></ol>
				...
				<fieldset id="unet & __unset">
					<legend>Magic method __unset</legend>
                    <p>Magic method ini akan dijalan ketika kita ingin menghapus property yang tidak ada
                    menggunakan funtion <em class="target">unset</em>.</p>
                    <p>Fungsi unset sendiri berfungsi untuk menghapus sebuah variable. magic mehod __unset membutuhkan 1 variable, yaitu
                    nama perperty yang akan dihapus.</p>
                    ...
                    <div>
                        <?php
                            class Produk {
                                ...
                                public function __construct ($merek,$stock){
                                    $this->merek = $merek;
                                    $this->stock = $stock;
                                }
                                
                                public function __unset ($name){
                                    echo "<h4>Sorry, property named $name isnt available to unset</h4>";
                                }
                            }
                            
                            $mesinCuci = new Produk ("Sharp",42);
                            echo "<pre>";
                                print_r ($mesinCuci);
                            echo "</pre>";
                            unset ($mesinCuci->merek); // its Works
                            unset ($mesinCuci->stock);
                            echo "<pre>";
                                print_r ($mesinCuci);
                            echo "</pre>";
                        ?>
                        <embed src="../script/magic-method-unset.pdf" width=600px height="250">
                    </div>
