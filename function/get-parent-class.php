    ...
    <div class="container">
        <div class="item">
            ...
            <ol id="here-home"></ol>
				...
				<fieldset id="get Parent Class">
					<legend>get Parent Class</legend>
                    <p>Fungsi get parent class befungsi untuk mencaritahu parent class dari sebuah class turunan. Membutuhkan
                        satu buah argumen string nama class. dan megembalikan string (nama parent class) jika ada , dan false jika
                        class tidak memiliki parent class.
                    </p>
                    <hr>
                    <div>
                        <?php
                            ...
                            var_dump (get_parent_class ("Elektronik"));
                            echo "<br>";
                            ...
                            ?>
                        <br>
                        <embed src="../script/function-get-parent-class.pdf" width=600px height="250">
                    </div>
                </fieldset>
