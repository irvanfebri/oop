    ...
    <div class="container">
        <div class="item">
            ...
            <ol id="here-home"></ol>
				...
				<fieldset id="class alias">
					<legend>class alias</legend>
                    <p>fungsi ini untuk membuat nama alias dari sebuah class tanpa menimpa nama class yang sebenarnya.</p>
                    <p>method ini membutuhkan dua buah argumen, yang pertama adalah nama class 'string' dan kedua adalah nama string
                    aliasnya 'string'.</p>
                    <hr>
                    <div>
                        <?php
                            ...
                            class_alias ('Produk','Pd');
                            
                            $obj = new Produk();
                            $obj2 = new Pd();
                            
                            echo "<em class='target'>\$obj</em> == <em class='target'>\$obj2</em>";
                            var_dump ($obj == $obj2 );
                            echo "<br>";
                            echo "<br>";
                            echo "<em class='target'>\$obj2</em> dari class Produk";
                            var_dump ($obj2 instanceof Produk);
                        ?>
                        <br>
                        <embed src="../script/function-alias-class.pdf" width=600px height="250">
