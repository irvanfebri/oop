    ...
    <div class="container">
        <div class="item">
            ...
            <ol id="here-home"></ol>
				...
				<fieldset id="is a">
					<legend>is a</legend>
                    <p>Fungsi ini dipakai untuk memeriksan apakah sebuah object adalah dari class tertentu atau turunan dari class tertentu.</p>
                    ...
                    <div>
                        <?php
                           ...
                           var_dump (is_a ($ob1,"parents")); // true
                           var_dump (is_a ($ob2,"parents")); // true
                           var_dump (is_a ($ob1,"kid")); // false
                           var_dump (is_a ($ob2,"another")); // false
                        ?>
                        <br>
                        <embed src="../script/function-is-a.pdf" width=600px height="250">
                    </div>
                </fieldset>
