    ...
    <div class="container">
        <div class="item">
            ...
            <ol id="here-home"></ol>
				...
				<fieldset id="is subclass of">
					<legend>is subclass of</legend>
                    <p>Fungsi ini dipakai untuk memeriksan apakah sebuah object turunan dari class tertentu (jika object dari class sekarang, akan menghasilkan false.</p>
                    <p>Fungsi ini butuh dua buah argumen, variabel yang akan diperiksa, dan (string) berisi nama class</p>
                    <hr>
                    <div>
                        <?php
                           class parents {      
                           ...
                           var_dump (is_subclass_of ($ob1,"parents")); // false
                           var_dump (is_subclass_of ($ob2,"parents")); // true
                           var_dump (is_subclass_of ($ob1,"kid")); // false
                           var_dump (is_subclass_of ($ob2,"another")); // false
                        ?>
                        <br>
                        <embed src="../script/function-is-subclass-of.pdf" width=600px height="250">
                    </div>
                </fieldset>
